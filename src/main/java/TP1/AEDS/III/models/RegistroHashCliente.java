...
public class RegistroHashCliente implements RegistroHashExtensivel<RegistroHashCliente> {
    private int id;           // Chave primária (ID do cliente)
    private long endereco;    // Endereço no arquivo de dados
    private short TAMANHO = 12; // int (4) + long (8) = 12 bytes

    public RegistroHashCliente() {
        this.id = -1;
        this.endereco = -1;
    }

    public RegistroHashCliente(int id, long endereco) {
        this.id = id;
